                ...
                <div className="grid lg:grid-cols-2 px-8 gap-10 text-zinc-800 mt-10">
                    <div className="flex flex-col items-center bg-slate-100 p-8 rounded-lg shadow-lg max-w-sm">
                        <div>
                            ...
                            <p className="opacity-60 text-center">برای تازه کار ها
                            </p>
                            <div className="flex flex-col items-center my-8">
                                <p className="font-extrabold text-4xl">50000 تومان
                                </p>
                                <p className="text-sm opacity-60">/ماهیانه
                                </p>
                            </div>
                        </div>
                    ...
                    <div
                        className="flex flex-col items-center bg-gradient-to-br from-blue-100 via-orange-100 to-purple-100 p-8 rounded-lg shadow-lg relative border-8 border-orange-200 max-w-sm">
                        ...
                        <div>
                            <div className="flex gap-4 justify-center">
                                <p className="font-extrabold text-3xl mb-2">پیشرفته

                                </p>
                            </div>
                            <p className="opacity-60 text-center">برای کار کشته ها
                            ...
                            <div className="flex gap-4 justify-center">
                                <div className="flex flex-col items-center my-8">
                                    <p className="font-extrabold text-4xl">10000 تومان

                                    </p>
                                    <p className="text-sm opacity-60">/6 ماه
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="flex flex-col gap-1">
                            <p className="flex items-center text-sm"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                ...
                                <b>+100 تا در خواست</b><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
