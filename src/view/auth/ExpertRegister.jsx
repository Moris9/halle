...
function ExpertRegister() {
    ...
    const [formData, setFormData] = useState({ name:'',email: '', password: '',c_password:'',national_code:''
        ,tel:'',category_id:'',subcategory_id:'' , service_id :''});

    const {setToken} = useStateContext();

    const handleChange = (e) => {
        // بررسی نام فیلد و تنظیم مقدار متناظر
    ...
    const handleSubmit = async (e) => {
        ...
        axiosClient.post(`/expert-register`, dataToSend, {
            headers: {
                                ...
                                <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                                    ...
                                    <div className="flex flex-col items-stretch w-[65%] ml-5 max-md:w-full">
                                        <div className="bg-white flex grow flex-col w-full mx-auto px-5 py-10 rounded-3xl max-md:max-w-full max-md:mt-12">
                                            ...
                                            <form onSubmit={handleSubmit} className="self-center flex w-[764px] max-w-full flex-col space-y-10">
                                                ...
                                                <div className="">
                                                    ...
                                                    <select
                                                        ...
                                                        value={category}
                                                        onChange={handleChange}
                                                        className="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200 dark:!border-white/10 text-black dark:text-white"
                                                        id="category"
                                                    >
                                                ...
                                                <div className="">
                                                    <label htmlFor="subcategory" className="text-sm text-navy-700 dark:text-white">ساب دسته بندی*</label>
                                                    <select
                                                        name="subcategory_id"
                                                        value={subcategory}
                                                        onChange={handleChange}
                                                        className="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200 dark:!border-white/10 text-black dark:text-white"
                                                        id="subcategory"
                                                        disabled={!category} // disabled when category not selected
                                                    >
                                                        <option>ساب دسته بندی را انتخاب کنید</option>
                                                        {loading && category ? (
                                                            data.categories.find(item => item.id === parseInt(category, 10)).sub_category.map(subItem => {
                                                                return (
                                                ...
                                                <div className="">
                                                    <label htmlFor="service" className="text-sm text-navy-700 dark:text-white">سرویس*</label>
                                                    <select
                                                        name="service_id"
                                                        value={service}
                                                        onChange={handleChange}
                                                        className="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200 dark:!border-white/10 text-black dark:text-white"
                                                        id="service"
                                                        disabled={!subcategory} // disabled when subcategory not selected
                                                    >
                                                        <option>سرویس تان را انتخاب کنید</option>
                                                        {loading && subcategory ? (
                                                            data.categories
                                                                .find(item => item.id === parseInt(category, 10))
                                                                .sub_category.find(subItem => subItem.id === parseInt(subcategory, 10))
                                                ...
                                                <button className="bg-sky-100 self-stretch items-center flex flex-col mr-3.5 mt-10 px-5 py-5 rounded-[30px_20px] max-md:max-w-full max-md:mr-2.5">
